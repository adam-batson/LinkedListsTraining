...
namespace LinkedListTraining_tests.Helpers
{
    public static class LinkedListBuilder
    {
         ...
         * Linked List Builder
         * 
         * Normally we would utilize our frameworks when using LinkedLists
         * and not write a method like below to create a LinkedList.  This 
         * list builder, however, is an alternative solution for us to work 
         * within the parameters and naming conventions of the problems posted at LeetCode.
         */
